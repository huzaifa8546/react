...
function App() {
  ...
  return (
    <div
      class="w-full h-screen flex itmes-center justify-center duration-200"
      style={{ backgroundColor: color }}
    >
      <div class="fixed flex flex-wrap justify-center bottom-13 inset-x-0 px-3">
        <div class="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-4 py-3 rounded-3xl">
          <button
